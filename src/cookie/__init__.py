...
class cookie:
    ...
    def get_user_id(self):
        self.user_id = requests.get("https://users.roblox.com/v1/users/authenticated", cookies={".ROBLOSECURITY": self.cookie}).json().get("id") #Don't worry i won't steal ur cookie.